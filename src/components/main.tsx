...
export const Main: React.FC = () => {
  ...
  const browserInfo =
    BROWSER_DOWNLOAD_INFO[currentBrowser as keyof typeof BROWSER_DOWNLOAD_INFO];
  ...
  return (
    <div className={styles.main}>
      <div className={styles.buttonGroup}>
        {isSmallScreen ? (
          <button
            className={clsx(styles.downloadMobileButtonSmall)}
            onClick={() => {
              window.open(
                currentMobile === "googlePlay"
                  ? DOWNLOAD_INFO_MOBILE.googlePlay.href
                  : DOWNLOAD_INFO_MOBILE.appStore.href,
                "_blank"
              );
            }}
          >
            <img
              ...
              src={
                currentMobile === "googlePlay"
                  ? "/assets/download/google-play-blue.svg"
                  : "/assets/download/apple-store-blue.svg"
              }
            />
            <div>
              Download for {currentMobile === "googlePlay" ? "Android" : "iOS"}
            </div>
          </button>
        ) : (
          <>
