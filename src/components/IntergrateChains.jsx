...
const IntergrateChains = () => {
  const chains = [
    ...
    { id: 137, name: "Polygon", icon: "/assets/images/chain-logos/polygon.svg" },
    ...
    { id: 888, name: "Wanchain", icon: "/assets/images/chain-logos/wanchain.svg" },
    { id: 321, name: "KCC", icon: "/assets/images/chain-logos/kcc.svg" },
    { id: 19, name: "Songbird", icon: "/assets/images/chain-logos/songbird.png" },
